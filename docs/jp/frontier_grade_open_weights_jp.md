...
私は2026年、『The Edge of Intelligence』という書籍を公開した。<br/>
...
3. Satoshi Yamauchi「The Edge of Intelligence — AIがあなたのデバイスで動く時代」（Leading.AI・CC BY 4.0）
   <https://github.com/Leading-AI-IO/edge-ai-intelligence>
4. MarkTechPost「Moonshot AI Releases Kimi K3: A 2.8 Trillion Parameter Open MoE Model With Kimi Delta Attention and 1M Context」（2026年7月16日）
...
5. Paddo「Distillation Is Not Scraping: Why the Internet's Favourite Take Is Wrong」（2026年7月）
   <https://paddo.dev/blog/distillation-is-not-scraping/>
6. OpenAI「OpenAI's comment to the NTIA on open model weights」（2024年3月提出）
   <https://openai.com/global-affairs/openai-s-comment-to-the-ntia-on-open-model-weights/>
7. Anthropic「Final Anthropic Response to Docket Number NTIA-2023-0009」（2024年3月提出）
...
※本書の調査では、①Anthropicの告発を第三者が検証した記録、②Moonshot・DeepSeek・MiniMaxによる技術的データに基づく公式反証、③蒸留が性能向上に占める寄与度の定量分解、④「DeepSeekは550万ドルで学習した」という主張の独立監査——のいずれも発見できなかった。Amodeiの2023年上院証言については、一次資料での逐語確認ができていないため、内容の断定を避けた。
...
**法文と運用は、別である。**<br/>
これが、71記事目以来私が「見えない審査」と呼んできた構造だ。<br/>
